...
<body>
    ...
    Madame/Monsieur {{$cape->name_pomoter}}, promotrice de l'orphelinat {{$cape->name}}, sis à {{$cape->address}} , arrondissement de {{$cape->district->name}} dans la commune de {{$cape->district->municipality->name}}
    a déposé au Ministère des Affaires Sociales et de la Micro Finance, le dossier de demande d'autorisation d'ouverture dudit orphelinat qui est en cours d'étude.   
     </p>
     <br><br>
