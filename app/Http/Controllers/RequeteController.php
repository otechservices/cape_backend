        ...
        if (request()->service_id) {
            ...
            switch ($role) {
                ...
                case 'Promoteur':
                    ...
                    $requetes=Requete::with(['parcours.user','TypeCape','service','lastParcours','files.file.TypeFile','files2','reponses.user'])->where('promoter_id',Auth::user()->promoter_id)->orderBy("id","desc")->get();
                    break;
